...
const Footer = () => {
  return (
    <div className="">
      <Registerpage />
      <footer className="bg-[#262341] text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4  md:gap-8 gap-8 mt-5 lg:mt-0 ">
            <div className='text-center   flex flex-col justify-center '>
              <Link to='/'>
                ...
                <img className=' w-35  p-1 rounded-lg' src="/images/ICMRST logo.png" alt="logo" />
              </Link>
            ...
            <div className="">
              <h4 className="lg:text-xl poppins-bold mb-2 ">ICMRST </h4>

              <p className="inter-medium tex-base text-justify">A global platform uniting researchers to share innovations and advance multidisciplinary science and technology solutions.</p>
            </div>
              ...
              <div className='flex gap-4 flex-wrap justify-start items-end '>
                <div className=''>
                  ...
                  <ul className="lg:text-base inter-medium text-sm space-y-2">
                    <li className='cursor-pointer'>Dhahran, Saudi Arabia</li>
                    <li className='cursor-pointer'>icmrst.org@gmail.com</li>
        ...
        <div className='grid lg:grid-cols-3 grid-cols-1  items-center    py-3 '>
          ...
          <div className="text-center md:text-base text-xs inter-regular">
            <p>© 2025 <span className='' > <Link to="/" target='_blank'>ICMRST </Link> </span> . All Rights Reserved.</p>
          </div>
        </div>
      </footer>
    </div>
