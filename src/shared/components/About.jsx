                    ...
                    <div className=" flex items-center  justify-center group">
                        ...
                        <div className="space-y-5 lg:space-y-0 flex   flex-col justify-center">
                            ...
                            <div className="space-y-3 mt-4">
                                ...
                                <p className="text-base inter-regular leading-[30px] opacity-85 text-justify">Dedicated to bridging research and practice, ICMRST provides a valuable platform for presenting findings, networking, and forming partnerships. Participants enhance expertise, explore cutting-edge trends, and create impactful solutions that address real-world problems across multiple scientific and technological domains.</p>
                            </div>
                        </div>
                    </div>
            </section>
