...
function Papersubmission() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const mailPromise = fetch('https://icmrst.org/api/mail.php', {
                method: 'POST',
                body: formDataToSend,
            });
        ...
        <div>
            <div className="lg:h-90 h-70  relative bg-cover bg-center " style={{ backgroundImage: "url('/images/allhero.png')" }}>
                ...
                <div className="relative z-10 flex flex-col justify-center items-center h-full space-y-2">
                    <h2 className="text-[28px] md:text-[36px] lg:text-[40px] poppins-medium text-white mt-10">Paper Submission</h2>
                    <div className="flex space-x-2 ">
                        <Link to='/'>
                            <h2 className=" text-[18px] sm:text-[22px] poppins-medium text-white hover:text-[#d12852] duration-300 ">Home</h2>
                        </Link>
                        <div className="flex justify-center items-center gap-1">  <span className="text-white  text-xl"><HiChevronDoubleRight /> </span><h2 className=" text-[18px] sm:text-[22px] poppins-medium  text-[#d12852] ">Paper Submission</h2></div>
            ...
            <div className="flex flex-col lg:flex-row gap-10 max-w-[1300px] mx-auto 2xl:px-0 px-4 lg:py-15 py-10">
                <div className="  flex flex-col  gap-10  ">
                    ...
                    <div className="bg-white shadow-[0_0_10px_rgba(0,0,0,0.15)] rounded-lg p-6 flex flex-col w-full h-full">
                        ...
                        <h2 className="poppins-bold text-xl text-[#d12852] mb-3">Submission Guidelines</h2>

                        <div className="flex gap-2  items-center"><TbPointFilled className='flex text-[18px] shrink-0 text-[#d12852] ' /> <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify ">Papers must be written in English</p></div>
                        <div className="flex gap-2  items-center"><TbPointFilled className='flex text-[18px] shrink-0 text-[#d12852] ' /> <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify ">Maximum length: 8 pages including figures and references</p></div>
                        <div className="flex gap-2  items-center"><TbPointFilled className='flex text-[18px] shrink-0 text-[#d12852] ' /> <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify ">Use the IEEE conference format</p></div>
                        <div className="flex gap-2  items-center"><TbPointFilled className='flex text-[18px] shrink-0 text-[#d12852] ' /> <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify ">Submit in PDF, Docx, PPTX format</p></div>
                        <div className="flex gap-2  items-center"><TbPointFilled className='flex text-[18px] shrink-0 text-[#d12852] ' /> <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify ">Include abstract (max 250 words)</p></div>
                        <div className="flex gap-2  items-center"><TbPointFilled className='flex text-[18px] shrink-0 text-[#d12852] ' /> <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify ">Blind all author information for review</p></div>
                    </div>

                    <div className="bg-white shadow-[0_0_10px_rgba(0,0,0,0.15)] rounded-lg p-6 flex flex-col w-full  h-full">

                        <h2 className="poppins-bold text-xl text-[#d12852] mb-3">Important Notes</h2>

                        <div className="flex gap-2  items-center"><TbPointFilled className='flex text-[18px] shrink-0 text-[#d12852] ' /> <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify ">All papers undergo a double-blind peer review process</p></div>
                        <div className="flex gap-2  items-center"><TbPointFilled className='flex text-[18px] shrink-0 text-[#d12852] ' /> <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify ">At least one author must register for the conference</p></div>
                        <div className="flex gap-2  items-center"><TbPointFilled className='flex text-[18px] shrink-0 text-[#d12852] ' /> <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify ">Plagiarism checks will be performed</p></div>
                        <div className="flex gap-2  items-center"><TbPointFilled className='flex text-[18px] shrink-0 text-[#d12852] ' /> <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify ">Multiple submissions are not allowed</p></div>
                        <div className="flex gap-2  items-center"><TbPointFilled className='flex text-[18px] shrink-0 text-[#d12852] ' /> <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify ">Authors must present accepted papers at the conference</p></div>
                        <div className="flex gap-2  items-center"><TbPointFilled className='flex text-[18px] shrink-0 text-[#d12852] ' /> <p className="text-lg inter-regular leading-[30px] opacity-85 text-justify ">Papers will be published in the conference proceedings</p></div>
                ...
                <div className=" max-w-[750px] w-full bg-white rounded-xl shadow-[0_0_10px_rgba(0,0,0,0.15)] flex items-center justify-center ">
                    <section className=" p-8 w-full flex flex-col h-full">
                        <h3 className="text-2xl poppins-semibold text-center mb-6 text-[#d12852]">Paper Submission</h3>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full border border-gray-300 outline-[#d12852] rounded-md p-2 shadow-sm text-base poppins-medium"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleFileInputChange}
                                    required
                                    className="w-full border poppins-medium outline-[#d12852] border-gray-300 rounded-md p-2 shadow-sm text-base"
                                >
                                    ...
                                    <option value="Advanced Nanotechnology">Advanced Nanotechnology</option>
                                    <option value="Modern Robotics">Modern Robotics</option>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <div className="w-full border poppins-medium outline-[#d12852] border-gray-300 rounded-md p-4  shadow-sm text-base text-center">
                                        <input
                                            id='Paper_File'
                                            name="Paper_File"
                                            accept=".pdf,.doc,.docx"
