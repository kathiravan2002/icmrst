...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'icmrst.org@gmail.com';
    $mail->Password   = 'lbbk osdl zuwx alif'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('icmrst.org@gmail.com', 'ICMRST Enquiry');
    $mail->addAddress('icmrst.org@gmail.com', 'ICMRST Enquiry');
    ...
    $replyMail->Username   = 'icmrst.org@gmail.com';
    $replyMail->Password   = 'lbbk osdl zuwx alif';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('icmrst.org@gmail.com', 'ICMRST Team');
    $replyMail->addAddress($_POST['email'], $_POST['firstname'] . ' ' . $_POST['secondname']);
    $replyMail->isHTML(true);
    $replyMail->Subject = 'Thank you for your enquiry - ICMRST 2025';
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICMRST 2025 Team</p>
        </div>
    ';
